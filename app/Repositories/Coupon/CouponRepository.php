...
class CouponRepository extends BaseRepository implements CouponRepositoryInterface
{
    ...
    public function dataTable()
    {
        return QueryBuilder::for(Coupon::class)
            ->allowedFilters(...['code', 'price', 'percent', 'status', 'id', 'start_time', 'end_time', 'min_order_value', 'max_order_value', 'created_at', 'user_id'])
            ->allowedSorts(...['code', 'price', 'percent', 'status', 'id', 'start_time', 'end_time', 'min_order_value', 'max_order_value', 'created_at', 'user_id'])
