...
class VlogController extends Controller
{
    ...
    {
        $this->vlogService->store($request->get("title"), $request->get("description"), $request->file("video"), $request->get("poster"), $request->get("url"), $request->get("status"));
    ...
    {
        $this->vlogService->update($request->get("id"), $request->get("title"), $request->get("description"), $request->file("video"), $request->get("poster"), $request->get("url"), $request->get("status"));
