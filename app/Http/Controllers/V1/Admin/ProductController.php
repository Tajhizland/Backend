...
class ProductController extends Controller
{
    ...
    {
        $response = $this->productService->searchList($request->get("categoryId"), $request->get("brandId"),$request->get("query"), $request->get("discountId"));
